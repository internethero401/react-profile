  ...
  return (
    <div id="whole">
      <div id="header" style={{ justifyContent: "center" }}>
        ...
        >
          <button className="element1_1" onClick={() => scroll("icon")}>
            Skill
          </button>
          <button
            className="element1_1"
            style={{ margin: "0px 100px" }}
            onClick={() => scroll("element3")}
          >
            Education
          </button>
          <button className="element1_1" onClick={() => scroll("element4")}>
            Hobby
          </button>
        </div>
        ...
        <div id="element1_2" style={{ float: "right", margin: "-500px 100px" }}>
          ...
          <div id="clickButtonCount" style={{ margin: "0px 25px" }}>
            {state2}
          </div>
        </div>
      </div>
      ...
      <div id="body2">
        ...
        <div id="element2">
          ...
          <div className="element_maintext">現在react,pythonを学習中です.</div>
          <div className="hogeMiniElement"></div>
          <div
            id="element2_skillBars"
            style={{
              display: "flex",
